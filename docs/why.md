...
`go-ruby-bigdecimal/bigdecimal` reimplements Ruby's BigDecimal in **pure Go, with cgo disabled**. The
...
- any Go program can import `github.com/go-ruby-bigdecimal/bigdecimal` directly, with no Ruby runtime;
