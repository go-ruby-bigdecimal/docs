...
Contributions are welcome. `go-ruby-bigdecimal/bigdecimal` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-bigdecimal/bigdecimal`](https://github.com/go-ruby-bigdecimal/bigdecimal). This documentation site is in
[`github.com/go-ruby-bigdecimal/docs`](https://github.com/go-ruby-bigdecimal/docs). Start from the
